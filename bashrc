...
if [[ "$INSIDE_EMACS" != 'vterm' ]]; then
    export PATH="/usr/local/opt/scala@2.11/bin:/usr/local/opt/postgresql@13/bin:/usr/local/opt/mysql-client/bin:/usr/local/sbin:$HOME/.cargo/bin:$GOPATH/bin:$HOME/.config/doom-emacs/bin:$PATH"
fi
